...
/// Initializes SDL, SDL_img and SDL_ttf subsystems for use within `kuma`
///
...
public:
	...
	/// subsystems and loads support for all image formats supported by
	/// SDL_img
	Init();
	...
	///
	/// Allows for initialization of specific subsystems and specific
	/// support of image formats for SDL_img
	Init(InitFlag sys_flag, ImgInitFlag img_flag);
	/// The default destructor terminates all SDL, SDL_img, and SDL_ttf
