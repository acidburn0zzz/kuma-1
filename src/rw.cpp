...
void RW::from_mem(void *mem) { inner = SharedRWPtr(SDL_RWFromMem(mem, sizeof(mem))); }

void RW::from_mem(const void *mem) { inner = SharedRWPtr(SDL_RWFromConstMem(mem, sizeof(mem))); }
