...
namespace kuma {
	...
	/// Class used to represent a rectangle on a 2D surface. This is used
	/// for
	/// setting all coordinates in `kuma` as well as sprite width and
	/// height.
	...
	public:
		...
		/// @return Returns a tuple of the rectangles position in the
		/// form of
